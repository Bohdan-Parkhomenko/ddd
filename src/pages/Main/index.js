...
const Main = () => {
    ...
    return (
        <div className="vh-100 bg-gray-200 h-7">
            ...
            <Row className="mb-3 ">
                <Col className="w-508 h-131 flex-shrink-0 rounded-lg bg-white shadow-md mr-3 ml-10">
                    ...
                    <div className="pt-2 pr-2 pb-1 pl-2">
                        ...
                        <Row>
                            <Col><p className="text-black text-default font-medium leading-6 mb-2">Info Number:</p>
                            </Col>
            ...
            <div className="w-64.75rem h-18.4375rem flex-shrink-0 rounded-lg bg-white shadow-md mr-10 ml-10">
                <div className="pt-2 pr-2 pb-1 pl-2 ">
                    ...
                    <Dropdown
                        className="wd w-62.25rem p-2.5 items-center gap-2 rounded-md border border-gray-300 bg-gray-50 mb-3">
                        <Dropdown.Toggle
                            variant="success" id="dropdown-basic"
                            className="flex flex-col flex-1 text-gray-600 text-md font-normal w-full"
                        >
